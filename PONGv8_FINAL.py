...
left_pad.color("red")
left_pad.shapesize(stretch_wid=6, stretch_len=0.5) #Tall Rectangular Paddle
left_pad.penup()                                   #Remove Drawing Tail
left_pad.goto(-400, 0)  #Added Tracer from Turtle to control screen updates (Speed Animation)
...
#============================================================
#Score Display and Instructions, Pause and Restart - T, Jack
#============================================================
...
#==========================================================================
#Ball Effects / Speed - Imported Random to Change Ball On Impact - Jack
#==========================================================================
...
#==============================================================================
#Pause, Restart, Difficulty Features - T
#==============================================================================
...
def cycle_menu_color():
    ...
    if game_state == "MENU" or game_state == "DIFFICULTY_MENU":
        ...
        # Increment the index, wrap around to 0 (% is a modulo operator, effectively tells the program to LOOP THIS once it reaches end of list) -T
